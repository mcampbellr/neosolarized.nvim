...
function M.setup(opts)
	...
	Group.new("Visual", colors.orange, colors.none, styles.reverse)
	...
	Group.new("Search", colors.orange, colors.none, styles.reverse)
	...
	if fn.has("nvim-0.8.0") then
		...
		Group.new("@tag.delimiter", colors.orange)
	end
