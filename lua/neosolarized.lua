...
function M.setup(opts)
	...
	Color.new("pink", "#c1416b")
	Color.new("red", "#6c71c4")
	...
	Group.new("Underlined", colors.violet, colors.none, styles.underline)
	...
	Group.new("Visual", colors.pink, colors.none, styles.reverse)
	...
	Group.new("Search", colors.pink, colors.none, styles.reverse)
	...
	Group.new("Title", colors.pink, colors.none, styles.bold)
	...
	Group.new("CursorLine", colors.pink, colors.none, styles.reverse)
	Group.new("CursorLineNr", colors.none, colors.none, styles.NONE)
	...
	Group.new("MatchParen", colors.magenta, colors.base01, styles.bold)
	...
	Group.new("NeomakeErrorSign", colors.pink)
	...
	Group.new("CmpItemKindConstructor", colors.pink, colors.none, styles.none)
	Group.new("CmpItemKindField", colors.yellow, colors.none, styles.none)
	Group.new("CmpItemKindVariable", colors.pink, colors.none, styles.none)
	...
	Group.new("CmpItemKindUnit", colors.pink, colors.none, styles.none)
	...
	Group.new("CmpItemKindEvent", colors.pink, colors.none, styles.none)
	Group.new("CmpItemKindOperator", colors.cyan, colors.none, styles.none)
	Group.new("CmpItemKindTypeParameter", colors.pink, colors.none, styles.none)
	...
	Group.new("TelescopeMatching", colors.pink, groups.Special, groups.Special, groups.Special)
	...
	if fn.has("nvim-0.8.0") then
		...
		Group.new("@tag.delimiter", colors.pink)
	end
